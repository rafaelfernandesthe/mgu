	...
	public Object criarUsuarioMaster( @RequestBody UsuarioMasterRequest usuarioMaster ) {
		...
		if ( !valido ) {
			try {
				...
				usuario.setFlMaster( SimNaoEnum.SIM );
				...
				mguResponse = ResponseUtils.mguResponse( CodigoMensagem.RETORNO_2 );// " <mgu><retorno>0</retorno><descricao> Usuário Master criado com sucesso! </descricao></mgu>";
			...
			mguResponse = ResponseUtils.mguResponse( CodigoMensagem.RETORNO_5 );// " <mgu><retorno>2</retorno><descricao> Usuário informado já existe em nossa base de dados. </descricao></mgu>";
		}
		return mguResponse;
	}
